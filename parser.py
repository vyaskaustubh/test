...
def parse():
    ...
    parser.add_argument('--kge_type', type=str, default='TransMS',
                        help='Specify the type of the knowledge graph embedding to use}.')

    parser.add_argument('--attn_type', type=str, default='baseline',
                        help='Specify the type of the attention to use}.')
